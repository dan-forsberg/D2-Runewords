...
function scrape() {
    ...
    async function fetchRuneWordData(runeword) {
        ...
        try {
            ...
            const items = document.querySelector("div[data-source='itypes'] div")?.innerText;
            const level = parseInt(document.querySelector("div[data-source='level'] div")?.innerText);
            const ladderOnlyText = document.querySelector("div[data-source='ladder'] div")?.innerText;
...
const data: Runeword[] = [
    ...
    {
        "runeword": "List of Armor Rune Words",
        "runes": [],
        "item": "nonmagic off-hand armor (shields, shrunken heads, paladin shields) with exactly 3 sockets",
        "level": 21,
        "ladderOnly": false
    ...
    {
        "runeword": "List of Weapon Rune Words",
        "runes": [],
        "item": "nonmagic off-hand armor (shields, shrunken heads, paladin shields) with exactly 3 sockets",
        "level": 21,
        "ladderOnly": false
    ...
    {
        "runeword": "List of Shield Rune Words",
        "runes": [],
        "item": "nonmagic off-hand armor (shields, shrunken heads, paladin shields) with exactly 3 sockets",
        "level": 21,
        "ladderOnly": false
    ...
    {
        "runeword": "List of Helm Rune Words",
        "runes": [],
        "item": "nonmagic off-hand armor (shields, shrunken heads, paladin shields) with exactly 3 sockets",
        "level": 21,
        "ladderOnly": false
